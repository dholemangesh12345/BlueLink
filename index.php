                ...
                <div class="col-md-8">
                    ...
                    <div class="post-container">
                        <?php
                            ...
                            $offset = ($page - 1) * $limit;
                            #-------------Pagination-------------#
                            $sql_query = "SELECT * FROM postsdata JOIN usersdata ON Pcreator = Uid JOIN categoriesdata ON Pcategory = Cid ORDER BY Pcreationdt DESC LIMIT {$offset}, {$limit}";
                      ...
                      <?php
                        ...
                        #-------------Pagination-------------#
                        $sql_query_pagination= "SELECT Pid FROM postsdata";
